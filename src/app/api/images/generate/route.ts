...
- Make sure the generated prompt specifies that there are NO people and NO hands in the frame. The objects must be entirely static, inanimate, and resting on a surface or floating in abstract space; they should never be shown being held, touched, typed on, or manipulated by human hands. Do NOT include any options representing hands, fingers, limbs, or humans, to ensure high visual quality.
